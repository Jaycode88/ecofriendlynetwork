...
class TestCategoryModel(TestCase):
    ...
    def test_category_str(self):
        ...
        category = Category.objects.create(name='TestCategory', friendly_name='Test Friendly Name')
...
class TestProductModel(TestCase):
    ...
    def test_product_str(self):
        ...
        product = Product.objects.create(name='TestProduct', category=category, price=9.99)
...
class TestViews(TestCase):
    ...
    def setUp(self):
        ...
        self.superuser = User.objects.create_superuser(username='testsuperuser', password='12345')
        # Create a test user and a sample product
        self.user = User.objects.create_user(username='testuser', password='12345')
        category = Category.objects.create(name='TestCategory')
        self.product = Product.objects.create(name='TestProduct', category=category, price=9.99)
    ...
    def test_product_detail_view(self):
        # Get the response from the product_detail view with the test product's ID
